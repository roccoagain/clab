...
int main(void) {
  ...
  err = putLifo(longq, (void *)1);
  assert(!err);
  err = putLifo(longq, (void *)2);
  assert(!err);
  err = putLifo(longq, (void *)3);
  assert(!err);

  err = putLifo(longq, (void *)4);
  assert(err);
  ...
  err = putLifo(stringq, "Hello");
  assert(!err);
  err = putLifo(stringq, "there");
  assert(!err);
  err = putLifo(stringq, "universe");
  assert(!err);
