 ...
 * the list ll1 is [0,1,2,3,4,5,6] then after running, ll1 will be empty, ll2
 * will be [0,2,4,6], and ll3 will be [1,3,5]. Returns 0 for successful
 * execution or returns -1 if any of the passed lists are NULL, ll2 or ll3 are
 * non-empty, or if either of the passed output lists (ll2 or ll3) is the input
 * list ll1.
 */
